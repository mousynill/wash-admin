    ...
    //if(isset($_POST['SubmitButton'])){ /*<--should be the name of the button*/
      ...
      if (in_array($fileActualExt, $allowed)) {
          ...
          for ($i=1; $i < 6; $i++) {
            ...
            $sql1 = "INSERT INTO videoquestions(questionContent, choiceOne, choiceTwo, choiceThree, correctAnswer, videoID) VALUES ('$question', '$choice1','$choice2','$choice3','$answer', '$rowNum')";
